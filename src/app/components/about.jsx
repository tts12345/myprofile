...
const About = () => {
  return (
    <section id="about" className="bg-gray-100 ">
      ...
      <img src= "/images/p1.jpg"  className="h-48 w-48 rounded-full" alt="image discription"  />
      </div>
      <div className="container mx-auto my-4 text-center">
        ...
        <p className="text-lg max-w-2xl text-red-600 mx-auto">
          I'm a programmer for creating beautiful, responsive websites. I love working with modern technologies like React.js and Tailwind CSS.
        </p>
      </div>
    </section>
  );
